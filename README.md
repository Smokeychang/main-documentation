...
Hello, my name is :blush: [Alejandro Sanchez](https://alesanchezr.com) and I'm the founder of BreatheCode, thank you for taking the time to read this!  :smile:
...
- **Libraries**: Some libraries are targeted to fix recurring coding challenges like: Session Management, Notifications, etc.
- **Apps**: We build software for teaching purposes only.
- **APIs**: Assets for teachers.
> Thanks to the [breathecode-cli](https://github.com/breatheco-de/breathecode-cli) we were able to include a set of [recommended boilerplates](https://github.com/breatheco-de/breathecode-cli/blob/master/boilerplates.json) to bootstrap projects in different technologies.

If you are interested in learning more about our current projects and developments please feel free to continue reviewing this document.

## Are you here to contribute?
Great! You can contribute to BreatheCode in four different ways:
- **BreatheCode Coder**: Join the development of any particular project, the majority of our repositories are being actively maintained and updated with new versions in our pipeline. Read this [if you want to become a **BreatheCode Coder**](#).
...
- **BreatheCode Fixer**: There are a lot of issues centering around our libraries, it is really hard to fix them all as more keep showing up :disappointed_relieved: Here is a small guide as to how to assist us in resolving bugs and issues!

## Our current projects

Please see below the 4 types of projects in which the BreatheCode is divided:
...
| Project 		| Description | Technologies |
| ---------- 	| -------------- | ---------------- |
| [CMS](https://github.com/breatheco-de/desktop-client) | This is where most of the community's content is published: Lessons, Error Explanations and "How to's". | Gatsby.js, CSS, React.js, Markdown, GIT |
